...
ActiveRecord::Schema.define(version: 2021_02_22_034738) do
  ...
  create_table "street_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["buyer_id"], name: "index_street_addresses_on_buyer_id"
  end
  ...
  add_foreign_key "street_addresses", "buyers"
end
